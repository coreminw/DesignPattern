...
public class MainWindow extends FrameWindow implements ActionListener {
    ...
    private static final String REMOVE_TEXTFIELD_OBSERVER_BUTTON_TITLE = "Update TextField Window Observer";
    private static final String REMOVE_LABEL_OBSERVER_BUTTON_TITLE = "Update Label Window Observer";
    private static final String ADD_TEXTFIELD_OBSERVER_BUTTON_TITLE = "Update TextField Window Observer";
    private static final String ADD_LABEL_OBSERVER_BUTTON_TITLE = "Update Label Window Observer";
    ...
    private boolean labelOberverAdded = true;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == updateTextFieldObserverButton) {
          ...
          //  updateTextFieldObserverButton.setText(TEXTFIELD_OBSERVER_BUTTON_TITLE + " 2");
            ...
            if(labelOberverAdded){
                primeThread.removeObserver(textFieldWindow);
                updateLabelObserverButton.setText(ADD_LABEL_OBSERVER_BUTTON_TITLE);
                labelOberverAdded=false;
            }
            else{
                primeThread.addObserver(labelWindow);
                updateLabelObserverButton.setText(REMOVE_LABEL_OBSERVER_BUTTON_TITLE);
                labelOberverAdded =true;
            }
